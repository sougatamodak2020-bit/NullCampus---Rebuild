...
import { User, Phone, Calendar, MapPin, Briefcase, Award, Loader2, ChevronRight } from 'lucide-react'
          ...
          <form onSubmit={handleSubmit} className="p-8">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white/50 dark:bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white"
            ...
            {step === 2 && (
              <motion.div
                ...
                className="space-y-6"
              >
                <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Professional Information</h2>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white/50 dark:bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white"
            ...
            {step === 3 && (
              <motion.div
                ...
                className="space-y-6"
              >
                <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Select Your Interests</h2>
            ...
            <div className="flex justify-between mt-8">
              {step > 1 && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-all text-gray-700 dark:text-gray-300"
                >
                  Previous
                </motion.button>
              )}
